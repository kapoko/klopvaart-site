...
<div <?= get_block_wrapper_attributes(["class" => "group z-10 fixed lg:static w-full max-w-full lg:w-auto lg:container mx-auto p-4 lg:p-0 lg:py-10 justify-end lg:justify-start flex items-center flex-col lg:flex-row text-white lg:text-[--wp--preset--color--contrast]"]) ?>
